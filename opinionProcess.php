...
{   
    ...
    $subject= "Wikreate | Enquiry From VENKATESHWAR HOSPITAL/Afghanistan"; //email subject line
...
$sender_name = filter_var($_POST["name"], FILTER_SANITIZE_STRING); 
	...
	//$highrisk = filter_var($_POST["highrisk"], FILTER_SANITIZE_STRING);
	//$caution = filter_var($_POST["caution"], FILTER_SANITIZE_STRING);
	//$lowrisk = filter_var($_POST["lowrisk"], FILTER_SANITIZE_STRING);
...
$msg=filter_var($_POST["query"], FILTER_SANITIZE_STRING); 
	...
	$sender_message .= "<br>";
	$sender_message .= "<br>";
	$sender_message .= "<strong>State :</strong>  $state";
	$sender_message .= "<br>";
	$sender_message .= "<br>";
	/*$sender_message .= "<strong>Risk Factor Score Red :</strong>  $highrisk";
	$sender_message .= "<br>";
	$sender_message .= "<br>";
	$sender_message .= "<strong>Risk Factor Score Yellow:</strong>  $caution";
	$sender_message .= "<br>";
	$sender_message .= "<br>";
	$sender_message .= "<strong>Risk Factor Score Green:</strong>  $lowrisk";
	$sender_message .= "<br>";
	$sender_message .= "<br>";*/
	...
	print "</script>"; */ 
	echo '<script type="text/javascript">';
    echo 'window.location.href="thankyou1.php";';
	echo '</script>';
